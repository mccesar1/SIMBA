...
if ( !empty($_POST) ) {
    ...
    if ( $valid ) {
        ...
        $sql = "INSERT INTO semestres (clave_semestre, nombre_semestre) values(?, ?)";
        $q = $pdo -> prepare($sql);
        $q -> execute(array($clave_semestre, $nombre_semestre));
        Database::disconnect();
    ...
    <div class="span10 offset1">
        ...
        <form class="form-horizontal" action="new.php" method="post">
            <div class="control-group <?php echo !empty( $claveError )?'error':'';?>">
                ...
                <div class="controls">
                    <input name="clave_semestre" type="text" placeholder="Clave de la semestre" value="<?php echo !empty( $clave_semestre )?$clave_semestre:'';?>">
            ...
            <div class="control-group <?php echo !empty( $nombreError )?'error':'';?>">
                ...
                <div class="controls">
                    <input name="nombre_semestre" type="text" placeholder="Nombre de la semestre" value="<?php echo !empty( $nombre_semestre )?$nombre_semestre:'';?>">
